...
1. **Collect facts:** The questionnaire captures the student's attributes and preferences.
2. **Match conditions:** The engine checks which rule conditions are satisfied.
3. **Fire rules:** Matching rules contribute evidence and scores to relevant degree profiles.
4. **Explain results:** The highest-scoring programmes are presented together with their supporting reasons.

## Knowledge Representation

| Component | Purpose |
|---|---|
| Production rules | Express domain knowledge as IF-THEN relationships |
| Degree frames | Store the defining characteristics of each programme |
| Semantic relationships | Connect related interests, traits, skills, and disciplines |
| Working facts | Represent answers gathered during the assessment |
| Inference engine | Matches facts to rules and calculates recommendation scores |
...
| Styling | CSS |
| Build tooling | Vite |
| Reasoning | Custom forward-chaining inference engine |
| Knowledge base | Modular JavaScript rule and frame definitions |
...
Additional material is available in [`docs/`](docs/), including:
...
[Sajeev Jayaparagasam](https://github.com/sajeev1003)
